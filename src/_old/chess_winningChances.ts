...
import { EvalScore } from './chess_ceval';
...
export const povAccuracy = (color: Color, before: EvalScore, after: EvalScore): number =>
103.1668 * Math.exp(-0.04354 * (povChances(color, before) * 100 - povChances(color, after) * 100)) - 3.1669